            ...
            return <table>
                <tbody><tr>
                    ...
                    <td style={{ fontFamily: 'Arial', textAlign: 'initial', fontStretch: 'normal', lineHeight: 'normal', padding: '0px 10px' }}>
                        ...
                        <a href={"tel:" + props.phone} style={{ fontFamily: 'Arial' }} target="_blank">
            ...
            return <table>
                <tbody><tr>
                    ...
                    <td style={{ fontFamily: 'Arial', textAlign: 'initial', fontStretch: 'normal', lineHeight: 'normal', padding: '0px 10px' }}>
                        ...
                        <br />
                        <span style={{ color: '#444444', fontSize: '12px' }}>{props.role}</span><br /><br />
                        <a href={"https://" + props.url} style={{ fontFamily: 'Arial' }} target="_blank">
            ...
            return <table>
                <tbody><tr>
                    ...
                    <td style={{ fontFamily: 'Arial', textAlign: 'initial', fontStretch: 'normal', lineHeight: 'normal', padding: '0px 10px' }}>
                        ...
                        <span style={{ color: '#444444', fontSize: '12px' }}>{props.role}</span><br /><br />
                        <a href={"https://" + props.url} style={{ fontFamily: 'Arial' }} target="_blank">
                            <span style={{ color: '#444444', fontSize: '12px' }}>{props.url}</span></a> | <a href={"tel:" + props.phone} style={{ fontFamily: 'Arial' }} target="_blank">
                            <span style={{ color: '#444444', fontSize: '12px' }}>{props.phone}</span></a>
                    </td>
                </tr>
                </tbody>
